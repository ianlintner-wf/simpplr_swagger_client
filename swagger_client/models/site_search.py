...
class SiteSearch(object):
    ...
    def __init__(self, size=None):  # noqa: E501
        """SiteSearch - a model defined in Swagger"""  # noqa: E501
        self._size = None
    ...
    @property
    def size(self):
        """Gets the size of this SiteSearch.  # noqa: E501


        :return: The size of this SiteSearch.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this SiteSearch.


        :param size: The size of this SiteSearch.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SiteSearch):
            return False
