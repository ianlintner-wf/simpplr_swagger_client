...
class UpdateAlert(object):
    ...
    def __init__(self, alert_id=None):  # noqa: E501
        """UpdateAlert - a model defined in Swagger"""  # noqa: E501
        self._alert_id = None
    ...
    @property
    def alert_id(self):
        """Gets the alert_id of this UpdateAlert.  # noqa: E501


        :return: The alert_id of this UpdateAlert.  # noqa: E501
        :rtype: str
        """
    ...
    def alert_id(self, alert_id):
        """Sets the alert_id of this UpdateAlert.


        :param alert_id: The alert_id of this UpdateAlert.  # noqa: E501
        :type: str
        """
        if alert_id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateAlert, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAlert):
            return False
